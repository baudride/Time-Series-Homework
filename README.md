...
1. Based on your time series analysis, would you buy the yen now? yes 
2. Is the risk of the yen expected to increase or decrease? decrease
3. Based on the model evaluation, would you feel confident in using these models for trading? no
...
Out of Sample Performance better 
